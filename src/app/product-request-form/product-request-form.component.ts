...
export class ProductRequestFormComponent implements OnInit, OnChanges, AfterViewInit, OnDestroy {
  ...
  attachmentFields: AttachemntObject[] = [
    ...
    },
    {
      ...
      fileName: '',
      fileValue: '',
      required: !this.kitProductStatus && !this.legacyStatus ? true : false,
      enable: true,
      attachmentTypeStatus: '',
      loadingStatus: false,
    },
    ...
    },
    {
      ...
      fileName: '',
      fileValue: '',
      required: this.selectedRequestedType === 8 || this.selectedRequestedType === 9 ? true : false,
      enable: true,
      attachmentTypeStatus: '',
      loadingStatus: false,
    },
  ...
  getFormAsStarting(data, fromWhere) {
    if (data) {
      ...
      this.regProductForAllRequestedType = this.fb.group({
        ...
        specificationsOfFinishedProduct: !this.kitProductStatus && !this.legacyStatus ? this.fb.control('', Validators.required) : this.fb.control(''),
